 ...
 * То есть когда метод переопределяется - это и есть полиморфизм. Есть класс Employee и там есть метод work и саут "сотрудник работает".
 ...
 * Выше две строки - объект Car имеет две связи. Поэтому это полиморфизм. А Object имеет одну связь - с собой.
 *
...
class q {
    public static void main(String[] args) {
        ...
        Employee5[] array2 = { new Teacher5(), new Driver5(), new Doctor5(), new Teacher5() };
        Help2_able2[] array3 = { new Teacher5(), new Driver5(), new Doctor5(), new Teacher5() };
